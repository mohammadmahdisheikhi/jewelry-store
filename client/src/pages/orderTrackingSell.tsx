...
function OrderTrackingSell({ user }: { user: UserProfile | null }): JSX.Element {
  if (!user) {
  ...
  return (
    <>
      ...
      <div className="mx-4 md:mx-8 lg:mx-20 my-10 gap-6 md:space-x-4">
        ...
        <div className="my-4">
          <span className="font-light text-gray-600 my-4">نام و نام خانوادگی خریدار:</span> <br />
        ...
        <div className="flex justify-center mb-6">
          <a href="/paymentSuccess" className="bg-button hover:bg-buttonHover text-white px-6 py-2 mt-4">پرداخت و ادامه فرایند خرید</a>
        </div>
      </div>
    </>
  );
...
export default function OrderTrackingSellPage(): JSX.Element {
  return (
    <UserLoader>
      {(user) => <OrderTrackingSell user={user} />}
    </UserLoader>
  );
}
