		...
		<>
			...
			<div className="mx-4 md:mx-8 lg:mx-20 my-10">
				...
				<div className="md:grid grid-cols-2 md:gap-8 space-y-4 md:space-y-0">
					<a
						href="/addad"
						className="flex justify-between align-baseline w-full p-4 text-white text-extrabold border-[1.5px] border border-secondary rounded-[2px] bg-secondary"
					>
						انتشار آگهی جدید
					...
					<a
						href="/personal"
						className="flex justify-between align-baseline w-full p-4 text-secondary text-extrabold border-[1.5px] border border-secondary rounded-[2px] bg-white"
					>
						اطلاعات شخصی و مالی
